...
onSubmit() {
  ...
  this.loading=true;
  this.newUser = new User(this.scs.ime.value,this.scs.prezime.value,this.scs.email.value,this.scs.lozinka.value ,this.scs.adresa.value,this.scs.telefon.value,0);
